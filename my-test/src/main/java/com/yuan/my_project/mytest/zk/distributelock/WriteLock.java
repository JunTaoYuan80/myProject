			...
			try {
				ZooKeeperOperation zopdel = new ZooKeeperOperation() {
					public boolean execute() throws KeeperException, InterruptedException {
						System.out.println(Thread.currentThread().getName() + " delete id:" + id);
	...
	private class LockZooKeeperOperation implements ZooKeeperOperation {
		...
		public boolean execute() throws KeeperException, InterruptedException {
			do {
				...
				if (id != null) {
					List<String> names = zookeeper.getChildren(dir, false);
					System.out.println(Thread.currentThread().getName() + " zookeeper.getChildren "+ JSONUtils.valueToString(names));
					if (names.isEmpty()) {
						...
						System.out.println(Thread.currentThread().getName() + " sortedNames.headSet "+ JSONUtils.valueToString(lessThanMe));
						if (!lessThanMe.isEmpty()) {
							...
							System.out.println(Thread.currentThread().getName() + " stat "+ JSONUtils.valueToString(stat));
							if (stat != null) {
							...
							if (isOwner()) {
								...
								//当前节点注册watcher事件
								zookeeper.exists(id, new LockWatcher());
								return Boolean.TRUE;
							}
						}
					}
